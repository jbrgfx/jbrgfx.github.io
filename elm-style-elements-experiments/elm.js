...
var _jbrgfx$elm_style_elements_experiments$Main$secondDropCap = A2(
	_mdgriffith$stylish_elephants$Element$paragraph,
	{
		ctor: '::',
		_0: _mdgriffith$stylish_elephants$Element$padding(40),
		_1: {
			ctor: '::',
	...
	},
	{
		...
		_0: A2(
			...
			_mdgriffith$stylish_elephants$Element$text('F')),
		_1: {
			ctor: '::',
			_0: A2(
				_mdgriffith$stylish_elephants$Element$paragraph,
				...
				{
					ctor: '::',
					_0: _mdgriffith$stylish_elephants$Element$text('or the time being, the layout width is static in this example. '),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					},
					{
						...
						label: _mdgriffith$stylish_elephants$Element$text('A responsive layout experiment has been begun.')
					}),
				_1: {ctor: '[]'}
			}
		}
	});
var _jbrgfx$elm_style_elements_experiments$Main$elmlogo = A2(
...
var _jbrgfx$elm_style_elements_experiments$Main$paddingLeft = function (n) {
	return _mdgriffith$stylish_elephants$Element$paddingEach(
		{right: 0, left: n, top: 0, bottom: 0});
};
var _jbrgfx$elm_style_elements_experiments$Main$paddingBottom = function (pxs) {
	return _mdgriffith$stylish_elephants$Element$paddingEach(
		{bottom: pxs, top: 0, left: 0, right: 0});
};
var _jbrgfx$elm_style_elements_experiments$Main$paddingTop = function (pxs) {
	return _mdgriffith$stylish_elephants$Element$paddingEach(
		{bottom: 0, top: pxs, left: 0, right: 0});
};
var _jbrgfx$elm_style_elements_experiments$Main$footerArea = A2(
	_mdgriffith$stylish_elephants$Element$row,
	{
		ctor: '::',
		_0: _mdgriffith$stylish_elephants$Element_Font$color(_elm_lang$core$Color$darkBlue),
		_1: {
			ctor: '::',
			_0: _jbrgfx$elm_style_elements_experiments$Main$paddingTop(20),
			_1: {ctor: '[]'}
		}
	},
	{
		...
		_0: A2(
			...
			},
			{
				...
				label: _mdgriffith$stylish_elephants$Element$text('Credit opsb/cv-elm for design of columns, borders and padding elements.')
			}),
		_1: {ctor: '[]'}
	});
var _jbrgfx$elm_style_elements_experiments$Main$paddingRight = function (n) {
	return _mdgriffith$stylish_elephants$Element$paddingEach(
		{right: n, left: 0, top: 0, bottom: 0});
};
var _jbrgfx$elm_style_elements_experiments$Main$borderBottom = function (n) {
	return _mdgriffith$stylish_elephants$Element_Border$widthEach(
		{right: 0, left: 0, top: 0, bottom: n});
};
var _jbrgfx$elm_style_elements_experiments$Main$borderRight = function (n) {
	return _mdgriffith$stylish_elephants$Element_Border$widthEach(
		{right: n, left: 0, top: 0, bottom: 0});
};
var _jbrgfx$elm_style_elements_experiments$Main$gutter = 20;
var _jbrgfx$elm_style_elements_experiments$Main$headerArea = A2(
	_mdgriffith$stylish_elephants$Element$row,
	{
		ctor: '::',
		_0: _mdgriffith$stylish_elephants$Element_Background$color(_elm_lang$core$Color$white),
		_1: {
			...
			_1: {
				ctor: '::',
				_0: _jbrgfx$elm_style_elements_experiments$Main$borderBottom(1),
				_1: {
					ctor: '::',
	...
	{
		ctor: '::',
		_0: _jbrgfx$elm_style_elements_experiments$Main$elmlogo,
		_1: {
			ctor: '::',
			_0: A2(
				_mdgriffith$stylish_elephants$Element$newTabLink,
				{
					ctor: '::',
					_0: _mdgriffith$stylish_elephants$Element$padding(_jbrgfx$elm_style_elements_experiments$Main$gutter),
					_1: {
						ctor: '::',
						_0: _mdgriffith$stylish_elephants$Element_Font$bold,
						_1: {
...
var _jbrgfx$elm_style_elements_experiments$Main$overview = A2(
	_mdgriffith$stylish_elephants$Element$paragraph,
	{
		ctor: '::',
		_0: _mdgriffith$stylish_elephants$Element$alignTop,
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _mdgriffith$stylish_elephants$Element$width(
								_mdgriffith$stylish_elephants$Element$px(420)),
							_1: {
								ctor: '::',
								_0: _mdgriffith$stylish_elephants$Element$height(
...
var _jbrgfx$elm_style_elements_experiments$Main$mainColumns = function (_p0) {
	var _p1 = _p0;
	return A2(
		_mdgriffith$stylish_elephants$Element$row,
		{
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _jbrgfx$elm_style_elements_experiments$Main$borderRight(1),
					_1: {
						ctor: '::',
						_0: _mdgriffith$stylish_elephants$Element_Border$color(_elm_lang$core$Color$darkBlue),
						_1: {
							ctor: '::',
							_0: _jbrgfx$elm_style_elements_experiments$Main$paddingRight(_jbrgfx$elm_style_elements_experiments$Main$gutter),
							_1: {ctor: '[]'}
						}
					}
				},
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _jbrgfx$elm_style_elements_experiments$Main$paddingLeft(_jbrgfx$elm_style_elements_experiments$Main$gutter),
						_1: {ctor: '[]'}
					},
					_p1.right),
				_1: {ctor: '[]'}
...
var _jbrgfx$elm_style_elements_experiments$Main$main = _elm_lang$virtual_dom$Native_VirtualDom.staticProgram(
	A2(
		_mdgriffith$stylish_elephants$Element$layout,
		{
			...
			_1: {
				ctor: '::',
				_0: _mdgriffith$stylish_elephants$Element$width(
					_mdgriffith$stylish_elephants$Element$px(900)),
				_1: {
					ctor: '::',
					_0: _jbrgfx$elm_style_elements_experiments$Main$paddingLeft(_jbrgfx$elm_style_elements_experiments$Main$gutter),
					_1: {ctor: '[]'}
		...
		A2(
			...
			{
				ctor: '::',
				_0: _jbrgfx$elm_style_elements_experiments$Main$headerArea,
				_1: {
					ctor: '::',
					_0: _jbrgfx$elm_style_elements_experiments$Main$mainColumns(
						{
							left: {
								ctor: '::',
								_0: _jbrgfx$elm_style_elements_experiments$Main$overview,
								_1: {
									ctor: '::',
									_0: _jbrgfx$elm_style_elements_experiments$Main$secondDropCap,
									_1: {ctor: '[]'}
								}
							},
							right: {
								ctor: '::',
								_0: _jbrgfx$elm_style_elements_experiments$Main$firstDropCap,
								_1: {ctor: '[]'}
							}
						}),
					_1: {
						ctor: '::',
						_0: _jbrgfx$elm_style_elements_experiments$Main$footerArea,
						_1: {ctor: '[]'}
					}
				}
			})));
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _jbrgfx$elm_style_elements_experiments$Main$main !== 'undefined') {
    _jbrgfx$elm_style_elements_experiments$Main$main(Elm['Main'], 'Main', undefined);
}
